...
# We also used it for methods like .isoformat(). We also used it to give us print statements to use in debugging. We also used it for features like Pycache. Lastly, we used it for date related methods like .strftime().
